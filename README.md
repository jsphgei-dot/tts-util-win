...
* **It keeps your place.** The Text tab is still there when you open the program again, and
  audio written from a script is offered that script's title as its file name.
